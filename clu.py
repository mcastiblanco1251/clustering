...
with row1_2:
    ...
    Esta App utiliza algoritmos de Machine Learning para hacer Agrupaciones de cualquier dataset que quieras hacer.
...
if st.checkbox("Ver ejemplo para el Data set Demo para ubicar el No. de Cluster Ideal por Método del Codo",value=False):
    fig, ax = plt.subplots(figsize=(8, 4))
    sns.lineplot(x=list(range(1, 11)), y=[308812.7800000001, 212840.16982097193, 143342.75157170597, 104374.1598511286, 75363.74835182933,58300.443321590676,51133.031385281414,44312.468812077226,40944.33737373738,37468.38857539068], ax=ax)
    ax.set_title('Búsqueda por Codo')
    ax.set_xlabel('Clusters')
    ax.set_ylabel('Inercia')
